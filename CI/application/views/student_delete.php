...
<br><br><hr><br>
<form action="<?php $this->load->helper('url'); ?> StudentDelete2?Did=<?php echo $id ?>" class="form-horizontal" role="form" method="post">
...
<td><input type="text" value="<?php echo $r->FirstName ?>" name ="txtFName"></td>
</tr>

<tr>
<td>Enter Last Name</td>
<td><input type="text" name ="txtLName" value="<?php echo $r->LastName;?>"   ></td>
</tr>
...
<td>
  <input type="radio" name="gender" value="male" <?php if($x==$m) echo 
  $chk1?>>Male
  <input type="radio" name="gender" value="female" <?php if($x==$f) echo $chk1;  ?>>Female
</td>
</tr>

<tr>
<td>Enter Mobile Number</td>
<td><input type="text" name ="txtNumber" value="<?php echo $r->MobileNo; ?>" ></td>
</tr>

<tr>
<td>Enter Email Id</td>
<td><input type="text" name ="txtEmail" value="<?php echo $r->EmailId; ?>"></td>
</tr>
...
<td><input type="text" name ="txtID"  value="<?php echo $r->IdNo; ?>"></td>
</tr>


<tr>
<td>Enter Enrollment Number</td>
<td><input type="text" name ="txtEnrollment"  value="<?php echo $r->EnrollNo; ?>"></td>
</tr>
...
<tr>
<td><input type="submit" name="btnSubmit" value="Delete Student Detail" ></td>
</tr>
