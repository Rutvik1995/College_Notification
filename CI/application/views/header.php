...
<!-- Mirrored from 192.69.216.111/themes/preview/ace/typography.html by HTTrack Website Copier/3.x [XR&CO'2013], Sat, 18 Jan 2014 05:18:10 GMT -->
<?php
//echo base_url();
//exit;
?>
			...
			<div class="navbar-container" id="navbar-container">
				...
				<div class="navbar-header pull-right" role="navigation">
					<ul class="nav ace-nav">
						<li class="grey">
							<a  class="dropdown-toggle" href="<?=base_url()?>index.php/display/MainPage">Main Page
						...
						<li class="light-blue">
							<a data-toggle="dropdown" href="#" class="dropdown-toggle">
								<img class="nav-user-photo" src="<?=base_url()?>assets/avatars/st.png" alt="Jason's Photo" />
							...
							<ul class="user-menu pull-right dropdown-menu dropdown-yellow dropdown-caret dropdown-close">
								...
								<li>
									<a href="<?=base_url()?>index.php/display">
										<i class="icon-off"></i>
										Logout
									</a>
								</li>
